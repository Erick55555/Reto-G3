...
public class Coche extends Vehiculo {
	...
	public Coche (String matricula, String numBastidor, String color, int numAsientos, float precio, String marca,
					String modelo, String fechaFab, int numPuertas, int capacidadMaletero) {
